...
/*
		修改i2c总线GPIO:
 		PB8/I2C1_SCL			RTC_SCK
 		PB9/I2C1_SDA			RTC_SDA
*/

/* 定义I2C总线连接的GPIO端口, 用户只需要修改下面4行代码即可任意改变SCL和SDA的引脚 */
#define GPIO_I2C_PORT  GPIOB			/* GPIO端口 */				
#define RCC_APB2Periph_I2C_PORT  RCC_AHB1Periph_GPIOB		/* GPIO端口时钟 */
...
#define I2C_SDA_READ()  GPIO_ReadInputDataBit(GPIO_I2C_PORT, I2C_SDA_PIN)	/* 读SDA口线状态 */
#define I2C_SCL_READ()  GPIO_ReadInputDataBit(GPIO_I2C_PORT, I2C_SCL_PIN)	/* 读SCL口线状态 */
...
void i2c_Configuration(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_APB2Periph_I2C_PORT, ENABLE);	/* 打开GPIO时钟 */

	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;		/* 设为输出口 */
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;		/* 设为开漏模式 */
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;	/* 上下拉电阻不使能 */
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_MHz;	   /* IO口50MHZ速度 */
