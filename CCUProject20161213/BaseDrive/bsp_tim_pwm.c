...
*	修改记录 :
*		版本号  日期        作者     说明
*		V1.0    2013-08-16  000  正式发布
*		V1.1	2014-06-15  000  完善 bsp_SetTIMOutPWM，当占空比=0和100%时，关闭定时器，GPIO配置为输出
*
* //官方例程的计算公式。
...
*	返 回 值: 无
*f=定时器时钟/period/(prescaler+1)  占空比=pulse/period
*********************************************************************************************************
*/
