...
INTEGER16 SlaveMap13 = 0x1234;		/* Mapped at index 0x200C, subindex 0x00 */
...
/* index 0x1006 :   Communication / Cycle Period. */
                    UNS32 TestSlave_obj1006 = 0x1E8480;	/* 2000000 */
...
/* index 0x1404 :   Receive PDO 5 Parameter. */
                    ...
                    UNS32 TestSlave_obj1404_COB_ID_used_by_PDO = 0x182;	/* 386 */
...
const indextable * TestSlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1800: i = 21;*callbacks = TestSlave_Index1800_callbacks; break;
		case 0x1801: i = 22;*callbacks = TestSlave_Index1801_callbacks; break;
		case 0x1802: i = 23;*callbacks = TestSlave_Index1802_callbacks; break;
		case 0x1803: i = 24;*callbacks = TestSlave_Index1803_callbacks; break;
		case 0x1804: i = 25;*callbacks = TestSlave_Index1804_callbacks; break;
		case 0x1A00: i = 26;break;
		case 0x1A01: i = 27;break;
		case 0x1A02: i = 28;break;
		case 0x1A03: i = 29;break;
		case 0x1A04: i = 30;break;
		case 0x2000: i = 31;break;
		case 0x2001: i = 32;break;
		case 0x2002: i = 33;break;
		case 0x2003: i = 34;break;
		case 0x2004: i = 35;break;
		case 0x2005: i = 36;break;
		case 0x2006: i = 37;break;
		case 0x2007: i = 38;break;
		case 0x2008: i = 39;break;
		case 0x2009: i = 40;break;
		case 0x200A: i = 41;break;
		case 0x200B: i = 42;break;
