...
static void InitNodes(CO_Data* d, UNS32 id)
{
	...
	if(strcmp(SlaveBoard.baudrate, "none")) {
		...
		{
			case MC1_MTD_NODEID:
				setNodeId(&TestSlave_Data,MC1_MTD_NODEID);
				break;
			case T_MTD_NODEID:
				setNodeId(&TestSlave_Data,T_MTD_NODEID);
				break;
			case M_MTD_NODEID:
				setNodeId(&TestSlave_Data,M_MTD_NODEID);
				break;
			case T1_MTD_NODEID:
				setNodeId(&TestSlave_Data,T1_MTD_NODEID);
				break;
			case T2_MTD_NODEID:
				setNodeId(&TestSlave_Data,T2_MTD_NODEID);
				break;
			case MC2_MTD_NODEID:
				setNodeId(&TestSlave_Data,MC2_MTD_NODEID);
				break;
			default :
				break;
		}
