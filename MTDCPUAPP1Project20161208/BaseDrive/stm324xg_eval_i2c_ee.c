/**
  ...
  *          
  *          ===================================================================      
  *          Note: This driver is intended for STM32F4xx families devices only.
  *          ===================================================================
  *              
  ...
  *          performed in sEE_LowLevel_Init() function declared in stm324xg_eval.c 
  *          file.
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Defines
  * @{
  */  
/**
  * @}
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Variables
  * @{
  */
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324xG_EVAL_I2C_EE_Private_Functions
  * @{
  */ 
...
{ 
  ...
  /*!< depending on the sEE Address selected in the stm324xg_eval_i2c_ee.h file */
...
{ 
  ...
  sEE_LowLevel_DMAConfig((uint32_t)pBuffer, (uint8_t)(*NumByteToWrite), sEE_DIRECTION_TX);
	...
	/* Inform the DMA that the next End Of Transfer Signal will be the last one */
  I2C_DMALastTransferCmd(sEE_I2C, DISABLE); 	//whh 关闭DMA自动生成NACK，这一句极其重要，没有这个E2prom无法写。
