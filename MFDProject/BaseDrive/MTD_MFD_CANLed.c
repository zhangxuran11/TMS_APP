...
/******************************************************************************************
*函数名称：void MTD_MFD_CANLED_LEDGpio_Init(void)
*
*入口参数：无
*
*出口参数：无
...
/********************************************************************************************
*函数名称：void MTD_MFD_CANLED_LED_On(uint8_t i)
*入口参数：无
*出口参数：无
*功能说明：点亮指定LED灯
*******************************************************************************************/
...
{
    GPIO_SetBits(MTD_MFD_CANLED_info[i].gpio,MTD_MFD_CANLED_info[i].pin);          //点亮指定LED灯  		
}

/********************************************************************************************
*函数名称：void MTD_MFD_CANLED_LED_Off(uint8_t i)
*入口参数：无
*出口参数：无
*功能说明：熄灭指定LED灯
*******************************************************************************************/
...
{
		GPIO_ResetBits(MTD_MFD_CANLED_info[i].gpio,MTD_MFD_CANLED_info[i].pin);    	   //关闭指定LED灯          
}

/********************************************************************************************
*函数名称：void MTD_MFD_CANLED_LED_Turn(uint16_t GPIO_Pin)
*入口参数：无
*出口参数：无
*功能说明：翻转指定LED灯状态
*******************************************************************************************/
