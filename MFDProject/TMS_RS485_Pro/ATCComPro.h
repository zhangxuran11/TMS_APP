...
#define  ATC_SD_TEXTCODEH8		0x03
#define  ATC_SD_TEXTCODEL8		0x0F 
...
typedef struct
{
	...
	u8 ATC_TrainIDL8;					//列车序号
	u8 ATC_TrainIDH8;					//列车序号
	u8 ATC_TrainDesIDendL8;		//最终目的地序号
	u8 ATC_TrainDesIDendH8;		//最终目的地序号
	
	/*byte18*/
	u8 Byte18Undef2Bit			:2;
	u8 ATC_Rdoorvaild				:1;//本站开B侧门
	u8 ATC_Ldoorvaild				:1;//本站开A侧门
	...
	/*byte40*/
	u8 ATC_TractionForward_1	:1;//牵引向前信号
	u8 ATC_BSideVaild_1				:1;//B侧门使能信号
	u8 ATC_AAideVaild_1				:1;//A侧门使能信号
	u8 ATC_HoldBrakeApplied_1	:1;//保持制动施加
	u8 ATC_TractionRemove_1		:1;//牵引切除
	u8 ATC_EBRD2Mode_1				:1;//信号系统EBRD2状态
	u8 ATC_EBRD1Mode_1				:1;//信号系统EBRD1状态
	u8 ATC_BMModeRelays_1			:1;	//BM模式继电器
	

	u8 ATC_TractionForward_6	:1;//牵引向前信号	
	u8 ATC_BSideVaild_6				:1;//B侧门使能信号
	u8 ATC_AAideVaild_6				:1;//A侧门使能信号
	u8 ATC_HoldBrakeApplied_6	:1;//保持制动施加
	u8 ATC_TractionRemove_6		:1;//牵引切除
	u8 ATC_EBRD2Mode_6				:1;//信号系统EBRD2状态
	u8 ATC_EBRD1Mode_6				:1;//信号系统EBRD1状态
	u8 ATC_BMModeRelays_6			:1;	//BM模式继电器
	
	
	/*byte41*/
	u8 ATC_DriveRoomMaster_6	:1;//司机室主控
	u8 ATC_BrakeCmd_6					:1;//制动指令
	u8 ATC_TractionCmd_6			:1;//牵引指令
	u8 Byte41Bit4							:1;
	u8 ATC_DriveRoomMaster_1	:1;//司机室主控
	u8 ATC_BrakeCmd_1					:1;//制动指令
	u8 ATC_TractionCmd_1			:1;//牵引指令
	u8 Byte41Bit0							:1;
	
	/*byte42*/
	u8 Undef6Bit							:4;
	u8 ATC_RMModeButt_6				:1;//RM模式按钮		
	u8 ATC_CBTCBMButton_6			:1;//CBTC/BM模式转换按钮
	u8 ATC_RMModeButt_1				:1;//RM模式按钮
	u8 ATC_CBTCBMButton_1			:1;//CBTC/BM模式转换按钮
