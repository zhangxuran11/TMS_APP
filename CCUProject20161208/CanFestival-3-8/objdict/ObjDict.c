...
/* index 0x100C :   Guard time. */					 
                    UNS16 ObjDict_obj100C = 0;					//	CO_Data 结构体中用到了未定义的 ObjDict_obj100C，故在对象字典中增加定义
...
/* index 0x1280 :   Client SDO 1 Parameter. */
                    ...
                    UNS8 ObjDict_obj1280_Node_ID_of_the_SDO_Server = 0x2;	/* 2 */
...
const indextable * ObjDict_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1400: i = 10;*callbacks = ObjDict_Index1400_callbacks; break;
		case 0x1401: i = 11;*callbacks = ObjDict_Index1401_callbacks; break;
