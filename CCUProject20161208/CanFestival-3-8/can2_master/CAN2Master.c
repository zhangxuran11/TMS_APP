		...
		if(CCU1 == 1)			//表示当前设备为ccu1
		{
				...
				if(CurrentUseCAN2 == UseState) 
				{
					...
					if(CAN2EmcyState == MainControlFaultSwitch)
					{
							...
							{	
								...
								{
									#ifdef DEBUG_PRINTF
										debugprintf("ccu1 can1 发送 errCode=0x41xx (副控)单点故障，可切换\r\n");
									#endif 
							...
							else
							{
									...
									#ifdef DEBUG_PRINTF
										debugprintf("ccu1 can1 发送 errCode=0x61xx  副控2坏，不可切换 \r\n");
									#endif
					...
					if(CAN2EmcyState == OnePointFaultSwitch) 
					{
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu1 can1 发送 0x41xx 可切换\r\n");
								#endif 
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu1 can1 发送 0x40xx 不可切换\r\n");
								#endif 
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu1 can1 发送 0x51xx 可切换\r\n");
								#endif
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu1 can1 发送 0x50xx 不可切换\r\n");
								#endif
			...
			else		//ccu1不是主控，去监控ccu2 设备的心跳
			{
				...
				if((CAN2EmcyState == MainControlFaultSwitch) && (g_RxCAN1HeartFlag[heartbeatID] == NoRxHeart))
				{
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu1 can2 0x61xx 主控2 不可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu1 can2 x60xx 主控2坏，可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu1 can2  x30xx 主控2坏，可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu1 can2 0x60xx主2 可切换\r\n");
						#endif
		...
		else		//表示使用的ccu2
		{
				...
				if(CurrentUseCAN2 == UseState)
				{
					...
					if(CAN2EmcyState == MainControlFaultSwitch)
					{
							...
							{							
								...
								{
									#ifdef DEBUG_PRINTF
										debugprintf("ccu2 can1 发送 errCode=0x41xx (副控)单点故障，可切换\r\n");
									#endif 
							...
							else
							{
								//errCode=0x61xx 主控1坏，不可切换 	
									#ifdef DEBUG_PRINTF
										debugprintf("ccu2 can2 发送 errCode=0x40xx  副控2坏，不可切换 \r\n");
									#endif
					...
					if(CAN2EmcyState == OnePointFaultSwitch) 
					{
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu2 can1 发送 0x41xx 可切换\r\n");
								#endif 
								Switch_LED_Display();  //切换led显示
								CAN2EmcyState = 	OnePointFaultSwitch;
								RecordErrorCoode = 0x4100 | heartbeatID;
								sendEMCY(&CCUCAN1Master_Data,RecordErrorCoode,*(CCUCAN1Master_Data.error_register),NULL,0);		//这里必须通过can2口发送
								return ;
							}
							//errCode=0x40xx  单点故障，不可切换 
							else if((k==1) && (j>1))
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu2 can1 发送 0x40xx 不可切换\r\n");
								#endif 
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu2 can1 发送 0x51xx 可切换\r\n");
								#endif
							...
							{
								#ifdef DEBUG_PRINTF
									debugprintf("ccu2 can1 发送  0x50xx 不可切换\r\n");
								#endif 
			...
			else		//ccu2不是主控，去监1 设备的心跳
			{
				...
				if((CAN2EmcyState == MainControlFaultSwitch)&& (g_RxCAN1HeartFlag[heartbeatID] == NoRxHeart))
				{
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu2 can2 0x61xx 中控1 不可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu2 can2 x60xx 主控1坏，可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu2 can2 x30xx 主控1坏，可切换\r\n");
						#endif 
					...
					{
						#ifdef DEBUG_PRINTF
							debugprintf("not main ccu2 can2 0x60xx 主1 可切换\r\n");
						#endif
