...
void can1master_recv_thread(void* p_arg)
{
  ...
  {	
	...
	//		}
		...
		BSP_OS_TimeDlyMs(3);			//调用这个延时是将其进入调度函数，发生任务的调度。		
  }
}
...
//	
////			writeLocalDict( &CCUCAN1Master_Data, /*CO_Data* d*/
////			0x1016, /*UNS16 index*/
////			0x01, /*UNS8 subind*/ 
...
UNS32  can1MasterGetHerat(CO_Data* d, const indextable * unsused_indextable, UNS8 unsused_bSubindex)
{
//		if(CCUcan1RxFlag == 1)
//		{
//			if(CCU1)
//			{
//				g_RxCAN1HeartStateFlag[2] = InOperatState;
//			}
//			
//			else
//			{
//				g_RxCAN1HeartStateFlag[1]= InOperatState;
//			}
//			
//			
//		}
