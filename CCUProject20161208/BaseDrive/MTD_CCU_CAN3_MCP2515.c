...
{		
	unsigned char state=0, res=CAN_NOMSG,SetMode=0,canstate=0;
		...
		//				
		//				//can_eflg = MTDCCU_CAN3_MCP2515_Read_Register(EFLG);
		//				//debugprintf("eflg=0x%x\r\n",state);

		//				//	state = MTDCCU_CAN3_MCP2515_Read_Status(SPICAN_READ_STATUS);
		...
		//			
		//					
		//		//		canstate = MTDCCU_CAN3_MCP2515_Read_Register(CANCTRL);
		//		//		debugprintf("stat=0x%x\r\n",canstate);
		//			
		//		//		canstate = MTDCCU_CAN3_MCP2515_Read_Register(TEC);
		//		//		debugprintf("TEC=0x%x\r\n",canstate);
		//		//	
		//		//			canstate = MTDCCU_CAN3_MCP2515_Read_Register(REC);
		...
		//		//		canstate= MTDCCU_CAN3_MCP2515_Read_Register(CNF2);
		//		//	debugprintf("cnf2=0x%x\r\n",canstate);
		...
		//		//		debugprintf("stat=0x%x\r\n",canstate);
		//		//		
		//		//		MTDCCU_CAN3_MCP2515_Read_CAN_Message(RXB0SIDH,&msg);
		//		//		printf("l=%d\r\n",msg.DLC);
		//		//		for(i=0;i<msg.DLC;i++)
		//		//		{
		//		//			debugprintf("a%d=0x%x\r\n",i,msg.Data[i]);
		//		//		}
		//		//		canstate = MTDCCU_CAN3_MCP2515_Read_Register(RXB1D0);
		//		//		printf("RDO=%d\r\n",canstate);
		//				
		//		//		canstate = MTDCCU_CAN3_MCP2515_Read_Register(CANSTAT);
		//		//		debugprintf("stat=0x%x\r\n",state);
		...
		//				//if(state ==0x00)
		//		//		{
		//		//				//MTDCCU_CAN3_MCP2515_IntError_Init(MCP2515_CAN_BAUD_125K);	//复位CAN3  //W HH,这里不一定要复位
	...
	while(1)
	{
		...
		if(state & MERRF)  //报文错误标志位
		{
			debugprintf("MERRF报文错误中断！\r\n");
							//MTDCCU_CAN3_MCP2515_IntError_Init(MCP2515_CAN_BAUD_125K);	//复位CAN3 /*WHH*/
