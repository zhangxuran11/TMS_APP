...
//				
//				for(i=0;i<8;i++)
//					printf("CAN1接受到CAN2数据,Rx1buf[%d]:0x%x\r\n",i,RxMessage.Data[i]);
//			
//			printf("\r\n");
...
//				
//				for(i=0;i<8;i++)
//					printf("CAN2接受到CAN1数据,Rx2buf[%d]:0x%x\r\n",i,RxMessage.Data[i]);		
//			printf("\r\n");			
//				
//			
//    }
...
//void EXTI15_10_IRQHandler(void)			//CAN3 的中断函数
//{
//		MCP2515_INT1_IRQ();
//}


//extern void MCP2515_INT2_IRQ(void);//CAN4 的中断函数
