...
void canDispatch(CO_Data* d, Message *m)
{
	 ...
	 switch(cob_id >> 7)
	{
		...
		case NODE_GUARD:
			...
			{
					/*W H H can1接受状态的改变,cculed 不需要接受其他设备的心跳*/
//				{
//					UNS8 nodeId = (UNS8) GET_NODE_ID((*m));
//					if(g_RxCAN1MesStateFlag[nodeId] == RxCanMesState)
//					{
//						g_RxCAN1MesStateFlag[nodeId] = RxCanNodeGuardMesState;
//					}
//					
//					else if(g_RxCAN2MesStateFlag[nodeId] == RxCanMesState)
//					{
//						g_RxCAN2MesStateFlag[nodeId] = RxCanNodeGuardMesState;
//					}
//				}
