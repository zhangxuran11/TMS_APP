...
#define sEE_I2C_SCL_PIN                  GPIO_Pin_1                  /* PF.01 */
#define sEE_I2C_SCL_GPIO_PORT            GPIOF                       /* GPIOF */
#define sEE_I2C_SCL_GPIO_CLK             RCC_AHB1Periph_GPIOF
#define sEE_I2C_SCL_SOURCE               GPIO_PinSource1
#define sEE_I2C_SCL_AF                   GPIO_AF_I2C2
#define sEE_I2C_SDA_PIN                  GPIO_Pin_0                  /* PF.00 */
#define sEE_I2C_SDA_GPIO_PORT            GPIOF                       /* GPIOF */
#define sEE_I2C_SDA_GPIO_CLK             RCC_AHB1Periph_GPIOF
#define sEE_I2C_SDA_SOURCE               GPIO_PinSource0
